...
arch-chroot /mnt /bin/sh << EOF
	...
	curl -LOs https://raw.githubusercontent.com/cole-sullivan/CALICS/main/tmp/mkinitcpio.conf
...
arch-chroot /mnt /bin/sh << EOF
	rm -f /etc/locale.gen
	curl -LOs https://raw.githubusercontent.com/cole-sullivan/CALICS/main/tmp/locale.gen
...
arch-chroot /mnt /bin/sh << EOF
	...
	curl -LOs https://raw.githubusercontent.com/cole-sullivan/CALICS/main/tmp/grub
	chmod 644 grub
